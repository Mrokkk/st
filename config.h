...
char *scroll = NULL;
char *stty_args = "stty raw pass8 nl -echo -iexten -cstopb 76800";
...
#define COLORS_SIZE 260

typedef struct {        /* terminal colors */
	const char* const colors[COLORS_SIZE];
...
static const ColorScheme schemes[] = {
	// my scheme
	{{// normal colors
	  "#1d1f21", "#c82829", "#718c00", "#f5871f",
	  "#4271ae", "#8959a8", "#3e999f", "#d6d6d6",
	  // bright colors
	  "#8e908c", "#ff3334", "#89aa00", "#eab700",
	  "#5795e6", "#b777e0", "#66bdc3", "#efefef",
	  [255] = "#1d1f21", "#cccccc", "#555555", "#c8c8c8",
	  "#121212"}, 258, 259, 258, 257},
